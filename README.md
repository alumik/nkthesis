...
| 引用对象 | 引用方式 | 引用样式（模式一，数字） | 引用样式（模式二，中文） |
| ------- | ------- | -------- | -------- |
| chapter | `\simpleref{chap:a}` | 第1章 | 第一章 |
| section | `\simpleref{sec:a}` | 第1.1节 | 第一节 |
| subsection | `\simpleref{subsec:a}` | 第1.1.1小节 | 第一小节 |
| subsubsection | `\simpleref{subsubsec:a}` | 第1.1.1.1子节 | 第一子节 |
